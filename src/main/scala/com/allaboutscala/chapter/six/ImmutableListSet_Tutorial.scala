...
object ImmutableListSet_Tutorial extends App {
  ...
  val emptyListSetMethod: ListSet[String] = ListSet.empty[String]
  println(s"Empty ListSet of type String = $emptyListSetMethod")

  println("\nStep 6: How to initialize an empty ListSet")
  val emptyListSet: ListSet[String] = ListSet()
